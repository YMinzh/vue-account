<template>
    <div class="CreateAcc">
        <Top left = "返回" center ="追加记账" @leftclick="back"></Top>

        <div class="main">

            <div class="accMoney"><MyInput :value="accMoney" isRtl=true name="剩余金额" type="text" height="30px" @getVal="getAccMoney"></MyInput><div class="disable"></div></div>
            <div><MyInput :value="money" isMust="true" isRtl=true  name="实付金额" type="text" height="30px" @getVal="getMoney" @callback="checkMoney" :isError="moneyCheck"></MyInput></div>
            <div><MyInput :value="date" isMust="true" isRtl=true  name="日期" type="date" height="30px" @getVal="getDate" @callback="checkDate" :isError="dateCheck"></MyInput></div>
        ...
        <div class="but">
            <MyButton bText='取消' height="30px" @callback="leftBtn"></MyButton>
            <MyButton bText='确定' height="30px" @callback="rightBtn"></MyButton>
        </div>
...
//        提交
        commit(){
            ...
            this.isLoading = true
            axios.request({
                url:   'api/record/sequel?token='+localStorage.usermsg,
                method: 'POST',
    ...
    mounted() {
        ...
        this.accMoney = this.items.accMoney
