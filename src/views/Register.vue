<template>
    <div class="Register">
        ...
        <div class="main">
            ...
            <div><MyInput name="密码" type="password" @getVal="getPassword" @callback="checkPassword" height="45px" :isError="passwordCheck"></MyInput></div>
            <div><Captcha :cUrl="cUrl" :value="captcha" height="45px" @getVal="getCaptcha" @callback="checkCap" @reCaptcha="askCaptcha" :isError="captchaCheck"></Captcha></div>
            ...
            <div class="buttons">
                ...
                <div><MyButton @callback="register" height="45px" bText="注册" bType="highLight"></MyButton></div>
            </div>    
        </div>
        <Alert :errorNews="errorNews" v-show="errorFlag" @callback="errorBack"></Alert>
        <loading :isLoading="isLoading"/>
        <ForgetFoot lText="如有问题" rText="请点这里"></ForgetFoot>
    </div>
